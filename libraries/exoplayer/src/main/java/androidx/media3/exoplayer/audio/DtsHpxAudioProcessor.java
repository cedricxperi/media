...
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileIsDTSEffectEnabled;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileGetOutputBufferSizeInBytes;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileProcessPCMInterleavedFloat;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileProcessPCMNonInterleavedFloat;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileProcessPCMInterleavedInteger;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileProcessPCMNonInterleavedInteger;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileReleasePCM;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileSetDTSEffectEnabled;
import static androidx.media3.dts.hpx.DtsHpxProcess.DTSHeadphoneXMobileVersion;
...
public final class DtsHpxAudioProcessor extends BaseAudioProcessor {
  ...
  private void InitDtsHpx() {

    // Create & Initialise DTS Headphone:X Mobile instance.if (channelCount != null && sampleRate != null) {

    int result = DTSHeadphoneXMobileInitialisePCM(CHANNEL_COUNT_DEFAULT, SAMPLING_RATE_DEFAULT, STEREO_MODE_DEFAULT.ordinal());
    ...
    if (DTSHeadphoneXMobileInstallLicense(license_file_buf)!=0)
    {
      // Handle exceptions here
      String msg = "License file %s cannot be installed. Possible that license is expired." + LICENSE_FILE_NAME;
      Log.e(TAG, msg);
    }
